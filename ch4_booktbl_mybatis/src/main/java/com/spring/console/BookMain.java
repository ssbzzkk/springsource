...
public class BookMain {
	...
	public static void main(String[] args) {
		...
		//도서 추가
//		BookDTO insertDto = new BookDTO(2023,"모두의알고리즘2023","이승찬", 25000,"파이썬 구현");
...
//		if(service.updateBook(40000,1008)) {
//			System.out.println("수정성공");
//		}
		
		//특정 도서 조회
//		BookDTO getRow = service.getBook(2023);
//		System.out.println(getRow);		
		
		//도서 삭제
//		if(service.deletetBook(1234)) {
