...
//		}
		...
		//oldList를 stream변환,
		List<Path> pathList = oldList.stream().map(dto->Paths.get("c:\\upload\\"+dto.getUploadPath()+"\\s_"+dto.getUuid()+"_"+dto.getFileName()))
	...
	private String getFolderYesterDay() {
		...
		return str.replace("-",File.separator); //운영체제에 맞는 폴더 구분자로 변경
